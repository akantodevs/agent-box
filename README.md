...
| `agent-box/scripts/sessions_page.html`    | The admin page's UI. `sessions.py` bakes `TTYD_PUBLIC_PORT` into it at startup so the rows can link to the terminal, and `AGENT_NAME` as the page's browser-tab title.                                                                                                                                                                                                                                                                      |
